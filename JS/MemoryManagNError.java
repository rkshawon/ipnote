...
const Garbage collection?
    *Garbage collection in JavaScript is a process that automatically manages memory by reclaiming unused memory occupied by objects
    that are no longer needed in a JavaScript program. JavaScript engines, like the one in browsers or Node.js,
    handle this process to ensure efficient memory usage and prevent memory leaks.
